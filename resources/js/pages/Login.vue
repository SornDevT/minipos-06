      ...
      <g id="Icon" transform="translate(27.000000, 15.000000)">
        ...
        <g id="Triangle" transform="translate(19.000000, 11.000000) rotate(-300.000000) translate(-19.000000, -11.000000) ">
          ...
          <div class="alert alert-danger" role="alert" v-if="show_error">
            ...
            <div class="mb-3">
              <button class="btn btn-primary d-grid w-100" type="submit" @click="Login()" >ເຂົ້າສູ່ລະບົບ</button>
            </div>
          ...
          if(this.email == '' || this.password == ''){
            ...
            this.$axios.post("/api/login",{
                      ...
                      if(response.data.success){
                        ...
                        // ເພີ່ມຂໍ້ມູນສະຖານະ login ໄປທີ່ Vue3 Storage
                        this.$storage.setStorageSync("isLoggin", true);

                      } else {
                          this.$swal(
                          'ການເຂົ້າສູ່ລະບົບບໍ່ສຳເລັດ!',
