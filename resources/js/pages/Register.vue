<template>
    <div class=" d-flex justify-content-center">
       ...
       <div class="authentication-inner col-md-5 ">
         <!-- Register -->
         <div class="card">
           <div class="card-body">
             <!-- Logo -->
           ...
           <g id="Triangle" transform="translate(19.000000, 11.000000) rotate(-300.000000) translate(-19.000000, -11.000000) ">
             ...
             <div class="alert alert-danger" role="alert" v-if="show_error">
               ...
               <div class="mb-3">
                 ...
                 <input type="text" class="form-control"  placeholder="ປ້ອນຊື່...." v-model="name">
               </div>
               <div class="mb-3">
                 <label  class="form-label">ອີເມວລ໌</label> <span class=" text-danger " v-if="check_email">ກະລຸນາປ້ອນອີເມວລ໌!</span>
                 <input type="text" class="form-control"  placeholder="ປ້ອນ email..." v-model="email" >
               </div>
               <div class="mb-3">
                 <label  class="form-label">ລະຫັດຜ່ານ</label>
                 <input type="password" class="form-control"   placeholder="ປ້ອນລະຫັດຜ່ານ..." v-model="password" >
               </div>
               <div class="mb-3">
                 <label  class="form-label">ຍືນຍັນລະຫັດຜ່ານ</label>
                 <input type="password" class="form-control"  placeholder="ປ້ອນລະຫັດຜ່ານ..." v-model="password2" >
               </div>
        ...
        register(){
                ...
                if( this.name == '' || this.email =='' || this.password == '' || this.password2 == ''){
                  ...
                  if(this.password == this.password2){
                    ...
                    this.show_error = true;
                    this.text_error = "ລະຫັດຜ່ານບໍ່ກົງກັນ ກະລຸນາກວດຄືນ!";
                  }
